...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 27 Ara 2015, 08:19:16
...
-- Veritabanı: `wtf_db`
--
CREATE DATABASE IF NOT EXISTS `wtf_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci;
USE `wtf_db`;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `searchRecipe`(IN `searchText` TEXT CHARSET utf8)
    NO SQL
SELECT *, ( LENGTH( `materials` ) - LENGTH( REPLACE( `materials`, '
', '' ) ) + 1 ) as materials_count, 
MATCH(`materials`) AGAINST(searchText IN BOOLEAN MODE) AS relevance 
FROM `foods` 
WHERE MATCH(`materials`) AGAINST(searchText IN BOOLEAN MODE) AND status ='active' AND deleted = 0
...
CREATE TABLE IF NOT EXISTS `admins` (
  ...
  `role` enum('editor','super_admin') COLLATE utf8_turkish_ci NOT NULL DEFAULT 'editor',
  PRIMARY KEY (`user_id`)
...
--
-- Tablo için tablo yapısı `approvals`
--
...
CREATE TABLE IF NOT EXISTS `approvals` (
  ...
  KEY `food_id` (`food_id`,`user_id`),
  KEY `admin_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci AUTO_INCREMENT=3 ;

--
-- Tablo döküm verisi `approvals`
--

INSERT INTO `approvals` (`approval_id`, `food_id`, `user_id`, `create_date`, `deleted`) VALUES
(1, 2, 1, '201512270055', 0),
(2, 19, 1, '201512270056', 0);
...
INSERT INTO `comments` (`comment_id`, `user_id`, `food_id`, `comment`, `create_date`, `deleted`) VALUES
(1, 3, 22, 'Çok harika bir lezzet', '201512270659', 0),
(25, 1, 22, 'Çok güzel tarif çok beğendim her gün yapıp yiyeceğim', '201512270753', 0);
...
CREATE TABLE IF NOT EXISTS `foods` (
  ...
  `status` enum('passive','active') COLLATE utf8_turkish_ci NOT NULL DEFAULT 'passive',
  `name` varchar(100) COLLATE utf8_turkish_ci NOT NULL,
...
(1, 'tavuk', 18, '201512252124', '201512270821', 0),
(2, 'domates', 54, '201512252124', '201512262025', 0),
(3, 'biber', 54, '201512252124', '201512262025', 0),
(4, 'un', 4, '201512252124', '201512252225', 0),
(5, 'kıyma', 8, '201512252124', '201512252245', 0),
(6, 'patates', 39, '201512252125', '201512252302', 0),
(7, 'bulgur', 11, '201512252137', '201512262025', 0),
...
(12, 'şeker', 8, '201512252211', '201512270753', 0),
...
(22, 'bal', 1, '201512252319', '201512252319', 0),
(23, 'dom', 3, '201512262023', '201512262024', 0),
(26, 'pirinç', 2, '201512262055', '201512262101', 0),
(27, 'zeytinyağ', 1, '201512262102', '201512262102', 0);
...
(1, 'Göksel', 'Pırnal', '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."', '19950424', '/no-pic.jpg', '201512220608', '201512270629', 0),
...
(4, NULL, NULL, 'Henüz profil düzenlenmemiş !', NULL, NULL, '201512262120', '201512262120', 0),
(5, 'Profile', 'Denemesi', 'Henüz profil düzenlenmemiş !', NULL, NULL, '201512262123', '201512262126', 0);
...
(1, 'yAidNJAz3d9Ob0yEwAUkUUNyHskxJb4Z', '201512270635'),
(3, 'Yd18xybAriquxpjy8mY078YzNbqt1tTp', '201512250624'),
(4, '1b9Jfo6YiEOJSjI7fdPK5HAGCCXxAiqo', '201512270620'),
(5, '8eBVdlvZPi9sN4a1t7BUIp5QQpH2I72e', '201512262124');
...
INSERT INTO `users` (`user_id`, `email`, `password`, `status`, `isAdmin`, `create_date`, `last_update_date`, `deleted`) VALUES
(1, 'gokselpirnal@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'active', 1, '201512220413', '201512220413', 0),
(2, 'doganderya59@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'active', 0, '201512220415', '201512220415', 0),
(3, 'tolgakuyucuk@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'active', 0, '201512250607', '201512250607', 0),
(4, 'deneme@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'active', 0, '201512262120', '201512262120', 0),
(5, 'profile@gmail.com', '36e1a5072c78359066ed7715f5ff3da8', 'active', 0, '201512262123', '201512262123', 0);
...
CREATE TRIGGER `createProfile` AFTER INSERT ON `users`
 FOR EACH ROW INSERT INTO profiles (user_id,about,create_date,last_update_date) VALUES(NEW.user_id,'Henüz profil düzenlenmemiş !',NEW.create_date,NEW.create_date)
//
DELIMITER ;
...
--
-- Tablo kısıtlamaları `approvals`
--
ALTER TABLE `approvals`
  ADD CONSTRAINT `approvals_ibfk_1` FOREIGN KEY (`food_id`) REFERENCES `foods` (`food_id`),
