...
angular.module("wtf").controller("FoodCtrl",["$scope","FoodService","CommentService","CategoryService","UserService","$state","$stateParams","$rootScope","$location","$cookies","ngNotify","$http",function(o,t,e,n,i,r,a,s,c,u,d,m){o.profile={},o.foods={},o.comments=[],o.food={},o.newFood={},o.newComment={},o.page=0,o.commentsPage=0,o.categories=[],o.selectedCategoryName="Kategori Seçiniz",o.material="",o.isLastPage=!1,o.isLastCommentsPage=!1,o.user=u.getObject("globals").currentUser,o.getPage=function(e){o.page=e,t.profile(e,function(t){t.error||t.user_id&&(o.profile=t)})},o.getComments=function(){o.isLastCommentsPage||t.getComments(a.foodId,o.commentsPage++,function(t){t.error||(console.log(t),(0==t.data.length||t.data.length<10)&&(o.isLastCommentsPage=!0),Array.prototype.push.apply(o.comments,t.data))})},o.sendComment=function(t){e.create(t,function(t){t.error||(console.log(t),o.comments.unshift(t.data),o.newComment={},d.set("Yorumunuz Kaydedildi",{position:"bottom",type:"error",duration:2e3,button:!0,sticky:!0}))})},o.removeComment=function(o){e.remove(o,function(o){200==o.status?d.set("Yorumunuz Silindi",{position:"bottom",type:"error",duration:2e3,button:!0,sticky:!0}):d.set("Yorumunuz silinemedi",{position:"bottom",type:"info",duration:2e3,button:!0,sticky:!0})})},o.detail=function(e){e=e||a.foodId,t.detail(e,function(t){200==t.status?o.food=t.data:d.set("Tarif bulunamadı !",{position:"bottom",type:"error",duration:2e3,button:!0,sticky:!0})})},o.getUserProfile=function(o){i.profile(o,function(o){return o})},o.saveFood=function(){t.create(o.newFood,function(t){t.error||(console.log(t),o.food=t,d.set("Tarifiniz Kaydedildi",{position:"bottom",type:"error",duration:2e3,button:!0,sticky:!0}))})},o.removeFood=function(o){t.remove(o,function(o){200==o.status?d.set("Tarfiniz Silindi",{position:"bottom",type:"error",duration:2e3,button:!0,sticky:!0}):d.set("Tarfiniz silinemedi",{position:"bottom",type:"info",duration:2e3,button:!0,sticky:!0})})},o.getFoodsFromCategoryId=function(){o.isLastPage||n.getFoods(a.categoryId,o.page++,function(t){t.error||(console.log(t),(0==t.length||t.length<6)&&(o.isLastPage=!0),Array.prototype.push.apply(o.foods,t))})},o.getCategories=function(){return s.categories?void(o.categories=s.categories):void n.getAll(function(t){t.error||(o.categories=t)})},o.setCategory=function(t){o.newFood.category_id=t.category_id,o.selectedCategoryName=t.name},o.addMaterial=function(t){t&&(o.newFood.materials?o.newFood.materials+="\n"+t:o.newFood.materials=t,o.material="")}}]);
...
angular.module("wtf").controller("LoginCtrl",["$scope","UserService","$rootScope","$location","$cookies","ngNotify","$http",function(o,t,a,e,s,n,l){var r=window.location.hash;"#/logout"==r&&s.putObject("globals",{}),o.user={email:"",password:""},o.login=function(o){var r=o.email,i=o.password;t.login(r,i,function(o){o.data.msg?n.set(o.data.msg,{position:"bottom",type:"error",duration:2e3,button:!0,sticky:!0}):200==o.status&&(t.setCredentials(o.data),s.putObject("globals",a.globals),l.defaults.headers.common.token=a.globals.currentUser.token,e.path("/"))})}}]);
...
angular.module("wtf").controller("RegisterCtrl",["$scope","UserService","$rootScope","$location","$cookies","ngNotify","$http",function(t,o,i,e,r,s,a){t.user={email:"",password:""},t.msg={show:!1},t.register=function(t){var i=t.email,r=t.password;o.register(i,r,function(t){t.data.msg?s.set(t.data.msg,{position:"bottom",type:"warn",duration:2e3,button:!0,sticky:!0}):200==t.status&&(s.set("Kaydınız tamamlandı. Giriş yapabilirsiniz.",{position:"bottom",type:"error",duration:2e3,button:!0,sticky:!0}),e.path("#/login"))})}}]);
...
angular.module("wtf").factory("CommentService",["$http","$rootScope",function(e,t){var n={};return n.create=function(n,o){e({method:"POST",url:t.serviceUrl+"/comment",data:n,headers:{"Content-Type":"application/json"}}).then(function(e){o(e)})},n.remove=function(n,o){e({method:"DELETE",url:t.serviceUrl+"/comment/"+n,data:null,headers:{"Content-Type":"application/json"}}).then(function(e){o(e)})},n}]);
angular.module("wtf").factory("FoodService",["$http","$rootScope",function(n,e){var t={};return t.getPage=function(t,o){n({method:"GET",url:e.serviceUrl+"/food/all/"+t,data:null,headers:{"Content-Type":"application/json"}}).then(function(n){o(n)})},t.getComments=function(t,o,a){n({method:"GET",url:e.serviceUrl+"/food/"+t+"/comments/"+o,data:null,headers:{"Content-Type":"application/json"}}).then(function(n){a(n)})},t.detail=function(t,o){n({method:"GET",url:e.serviceUrl+"/food/"+t,data:null,headers:{"Content-Type":"application/json"}}).then(function(n){o(n)})},t.create=function(t,o){n({method:"POST",url:e.serviceUrl+"/food",data:t,headers:{"Content-Type":"application/json"}}).then(function(n){o(n)})},t.update=function(t,o){n({method:"PUT",url:e.serviceUrl+"/food/"+t.food_id,data:null,headers:{"Content-Type":"application/json"}}).then(function(n){o(n)})},t.remove=function(t,o){n({method:"DELETE",url:e.serviceUrl+"/food/"+t,data:null,headers:{"Content-Type":"application/json"}}).then(function(n){o(n)})},t}]);
...
angular.module("wtf").factory("UserService",["$http","$rootScope",function(e,n){var t={};return t.register=function(t,o,r){var a={email:t,password:o};e({method:"POST",url:n.serviceUrl+"/register",data:a,headers:{"Content-Type":"application/json"}}).then(function(e){r(e)})},t.login=function(t,o,r){var a={email:t,password:o};e({method:"POST",url:n.serviceUrl+"/login",data:a,headers:{"Content-Type":"application/json"}}).then(function(e){r(e)})},t.setCredentials=function(e){n.globals={currentUser:{_id:e.user_id,email:e.email,token:e.token.token}}},t.profile=function(t,o){e({method:"GET",url:n.serviceUrl+"/user/"+(t||n.globals.currentUser._id)+"/profile",data:null,headers:{"Content-Type":"application/json"}}).then(function(e){o(e.data)})},t.foods=function(t,o,r){e({method:"GET",url:n.serviceUrl+"/user/"+(t||n.globals.currentUser._id)+"/foods/"+(o||0),data:null,headers:{"Content-Type":"application/json"}}).then(function(e){r(e.data)})},t.updateProfile=function(t,o){e({method:"PUT",url:n.serviceUrl+"/user/profile",data:t,headers:{"Content-Type":"application/json"}}).then(function(e){o(e)})},t}]);