...
angular.module("wtf").controller("RegisterCtrl",["$scope","UserService","$rootScope","$location","$cookies","ngNotify","$http",function(t,o,i,e,r,s,a){t.user={email:"",password:""},t.msg={show:!1},t.register=function(t){var i=t.email,e=t.password;o.register(i,e,function(t){t.data.msg?s.set(t.data.msg,{position:"bottom",type:"warn",duration:2e3,button:!0,sticky:!0}):200==t.status&&s.set("Kaydınız tamamlandı. Giriş yapabilirsiniz.",{position:"bottom",type:"error",duration:2e3,button:!0,sticky:!0})})}}]);
